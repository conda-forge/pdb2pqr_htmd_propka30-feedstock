About pdb2pqr_htmd_propka30-feedstock
=====================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pdb2pqr_htmd_propka30-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9591&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pdb2pqr_htmd_propka30-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pdb2pqr_htmd_propka30` can be installed with `conda`:
...
```
mamba install pdb2pqr_htmd_propka30
```

It is possible to list all of the versions of `pdb2pqr_htmd_propka30` available on your platform with `conda`:
...
```
mamba search pdb2pqr_htmd_propka30 --channel conda-forge
```
...
mamba repoquery search pdb2pqr_htmd_propka30 --channel conda-forge

# List packages depending on `pdb2pqr_htmd_propka30`:
mamba repoquery whoneeds pdb2pqr_htmd_propka30 --channel conda-forge

# List dependencies of `pdb2pqr_htmd_propka30`:
mamba repoquery depends pdb2pqr_htmd_propka30 --channel conda-forge
```
